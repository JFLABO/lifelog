...
if (file_exists('/var/www/lifelog/DATA/boost/m/'.$newstr)) {
    //echo "ファイルが存在する！！";
    header('Content-Type: image/jpeg');
    readfile('/var/www/lifelog/DATA/boost/m/'.$newstr);
} else {
...
ImageJpeg( $new_image , '/var/www/lifelog/DATA/boost/m/'.$newstr , 80 );
